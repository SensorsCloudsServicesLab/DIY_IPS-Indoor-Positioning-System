...
## Activities
![Main Activity](/image/main_activity.jpg "Main Activity")  

The project includes two main activities:  
1. The first activity allows you to sample, record, and upload WiFi RSSI values  
![RSSI Sampling Activity](/image/rssi_activity.jpg "RSSI Sampling Activity")

2. The second activity allows you to see your current position indoors.  
![Indoor Positioning Activity](/image/positioning_activity.jpg "Indoor Positioning Activity")
