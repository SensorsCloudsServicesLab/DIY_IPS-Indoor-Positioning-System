...
import indoorpositioningmodel.JoeModel;
import indoorpositioningmodel.Position;
import indoorpositioningmodel.ToastManager;

public class JoeModelActivity extends AppCompatActivity {
    ...
    private JoeModel joeModel = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.joeModel = new JoeModel(this);
    ...
    private void loadAccuracyRecords() {
        ...
        File localRecordsFile = new File(path, "accuracy_records_joe_model.json");
        try {
    ...
    private void displayFreshContent() {
        ...
        Position estimateLocation = joeModel.getLocation(directionManager.getCurrentDegreesFromNorth());
    ...
    private void saveObservation() {
        ...
        try {
            ...
            // Euclidean distance between reference location and estimate location
            newRecord.put("error", error);
            // Number of SCSLAB WiFi access points
            newRecord.put("AP_count", wifiAPs.getAPCount());
